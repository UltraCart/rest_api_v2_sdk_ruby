...
*UltracartClient::ConversationApi* | [**get_pbx_pay_connectors**](docs/ConversationApi.md#get_pbx_pay_connectors) | **GET** /conversation/pbx/pay_connector | Get pbx pay connectors
...
*UltracartClient::SfvbApi* | [**add_sfvb_page_blog_posts**](docs/SfvbApi.md#add_sfvb_page_blog_posts) | **POST** /sfvb/storefronts/{storefront_oid}/pages/blog_posts/add | Assign blog posts to a page
*UltracartClient::SfvbApi* | [**add_sfvb_page_items**](docs/SfvbApi.md#add_sfvb_page_items) | **POST** /sfvb/storefronts/{storefront_oid}/pages/items/add | Assign items to a page
*UltracartClient::SfvbApi* | [**archive_sfvb_upsell_path**](docs/SfvbApi.md#archive_sfvb_upsell_path) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_paths/{upsell_path_oid}/archive | Archive an upsell path
...
*UltracartClient::SfvbApi* | [**create_sfvb_preview_access**](docs/SfvbApi.md#create_sfvb_preview_access) | **POST** /sfvb/storefronts/{storefront_oid}/preview_access | One time link that opens a preview in a browser with no UltraCart login
...
*UltracartClient::SfvbApi* | [**delete_sfvb_item_attribute**](docs/SfvbApi.md#delete_sfvb_item_attribute) | **DELETE** /sfvb/storefronts/{storefront_oid}/items/attributes | Delete an attribute from an item
*UltracartClient::SfvbApi* | [**delete_sfvb_item_multimedia**](docs/SfvbApi.md#delete_sfvb_item_multimedia) | **DELETE** /sfvb/storefronts/{storefront_oid}/items/multimedia | Detach an image from an item
...
*UltracartClient::SfvbApi* | [**disable_sfvb_upsell_offer**](docs/SfvbApi.md#disable_sfvb_upsell_offer) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_offers/{upsell_offer_oid}/disable | Disable an upsell offer
*UltracartClient::SfvbApi* | [**disable_sfvb_upsell_path**](docs/SfvbApi.md#disable_sfvb_upsell_path) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_paths/{upsell_path_oid}/disable | Disable an upsell path
...
*UltracartClient::SfvbApi* | [**duplicate_sfvb_page**](docs/SfvbApi.md#duplicate_sfvb_page) | **POST** /sfvb/storefronts/{storefront_oid}/pages/duplicate | Copy a page to a new path
...
*UltracartClient::SfvbApi* | [**duplicate_sfvb_upsell_offer**](docs/SfvbApi.md#duplicate_sfvb_upsell_offer) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_offers/{upsell_offer_oid}/duplicate | Duplicate an upsell offer
*UltracartClient::SfvbApi* | [**duplicate_sfvb_upsell_path**](docs/SfvbApi.md#duplicate_sfvb_upsell_path) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_paths/{upsell_path_oid}/duplicate | Duplicate an upsell path or one of its variations
*UltracartClient::SfvbApi* | [**end_sfvb_experiment**](docs/SfvbApi.md#end_sfvb_experiment) | **POST** /sfvb/storefronts/{storefront_oid}/experiments/{experiment_oid}/end | End an experiment
...
*UltracartClient::SfvbApi* | [**get_sfvb_experiment**](docs/SfvbApi.md#get_sfvb_experiment) | **GET** /sfvb/storefronts/{storefront_oid}/experiments/{experiment_oid} | Read one experiment and its statistics
*UltracartClient::SfvbApi* | [**get_sfvb_experiment_objectives**](docs/SfvbApi.md#get_sfvb_experiment_objectives) | **GET** /sfvb/storefronts/{storefront_oid}/experiments/objectives | List the objectives an experiment can optimize
...
*UltracartClient::SfvbApi* | [**get_sfvb_item**](docs/SfvbApi.md#get_sfvb_item) | **GET** /sfvb/storefronts/{storefront_oid}/items | Read an item's storefront facing content
...
*UltracartClient::SfvbApi* | [**get_sfvb_menu**](docs/SfvbApi.md#get_sfvb_menu) | **GET** /sfvb/storefronts/{storefront_oid}/menus/{code} | Read one store menu and its entries
*UltracartClient::SfvbApi* | [**get_sfvb_menus**](docs/SfvbApi.md#get_sfvb_menus) | **GET** /sfvb/storefronts/{storefront_oid}/menus | List a storefront's store menus
...
*UltracartClient::SfvbApi* | [**get_sfvb_page_blog_posts**](docs/SfvbApi.md#get_sfvb_page_blog_posts) | **GET** /sfvb/storefronts/{storefront_oid}/pages/blog_posts | Read the blog posts assigned to a page
*UltracartClient::SfvbApi* | [**get_sfvb_page_items**](docs/SfvbApi.md#get_sfvb_page_items) | **GET** /sfvb/storefronts/{storefront_oid}/pages/items | Read the items assigned to a page
*UltracartClient::SfvbApi* | [**get_sfvb_page_selectors**](docs/SfvbApi.md#get_sfvb_page_selectors) | **GET** /sfvb/storefronts/{storefront_oid}/pages/selectors | Read a page's selectors
...
*UltracartClient::SfvbApi* | [**get_sfvb_site_attributes**](docs/SfvbApi.md#get_sfvb_site_attributes) | **GET** /sfvb/storefronts/{storefront_oid}/attributes | Read a storefront's site attributes
...
*UltracartClient::SfvbApi* | [**get_sfvb_upsell_offer**](docs/SfvbApi.md#get_sfvb_upsell_offer) | **GET** /sfvb/storefronts/{storefront_oid}/upsell_offers/{upsell_offer_oid} | Get an upsell offer
*UltracartClient::SfvbApi* | [**get_sfvb_upsell_path**](docs/SfvbApi.md#get_sfvb_upsell_path) | **GET** /sfvb/storefronts/{storefront_oid}/upsell_paths/{upsell_path_oid} | Get an upsell path
...
*UltracartClient::SfvbApi* | [**insert_sfvb_page**](docs/SfvbApi.md#insert_sfvb_page) | **POST** /sfvb/storefronts/{storefront_oid}/pages | Create a page
*UltracartClient::SfvbApi* | [**insert_sfvb_upsell_offer**](docs/SfvbApi.md#insert_sfvb_upsell_offer) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_offers | Create an upsell offer
*UltracartClient::SfvbApi* | [**insert_sfvb_upsell_path**](docs/SfvbApi.md#insert_sfvb_upsell_path) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_paths | Create an upsell path
*UltracartClient::SfvbApi* | [**install_sfvb_library_entry**](docs/SfvbApi.md#install_sfvb_library_entry) | **POST** /sfvb/storefronts/{storefront_oid}/library/{library_oid}/install | Install a library entry into a storefront
*UltracartClient::SfvbApi* | [**list_sfvb_blog_posts**](docs/SfvbApi.md#list_sfvb_blog_posts) | **GET** /sfvb/storefronts/{storefront_oid}/blog_posts | List the storefront's blog posts
*UltracartClient::SfvbApi* | [**list_sfvb_container_versions**](docs/SfvbApi.md#list_sfvb_container_versions) | **GET** /sfvb/storefronts/{storefront_oid}/container_versions | Version history for a container stored outside the file system
*UltracartClient::SfvbApi* | [**list_sfvb_elements**](docs/SfvbApi.md#list_sfvb_elements) | **GET** /sfvb/elements | List every SFVB element type
*UltracartClient::SfvbApi* | [**list_sfvb_experiments**](docs/SfvbApi.md#list_sfvb_experiments) | **GET** /sfvb/storefronts/{storefront_oid}/experiments | List the storefront's experiments
*UltracartClient::SfvbApi* | [**list_sfvb_file_versions**](docs/SfvbApi.md#list_sfvb_file_versions) | **GET** /sfvb/storefronts/{storefront_oid}/files/versions | Version history for a storefront file
*UltracartClient::SfvbApi* | [**list_sfvb_files**](docs/SfvbApi.md#list_sfvb_files) | **GET** /sfvb/storefronts/{storefront_oid}/files | List a storefront directory
*UltracartClient::SfvbApi* | [**list_sfvb_item_containers**](docs/SfvbApi.md#list_sfvb_item_containers) | **GET** /sfvb/storefronts/{storefront_oid}/item_containers | List the item containers on the account
*UltracartClient::SfvbApi* | [**list_sfvb_pages**](docs/SfvbApi.md#list_sfvb_pages) | **GET** /sfvb/storefronts/{storefront_oid}/pages/list | List the storefront's pages
*UltracartClient::SfvbApi* | [**list_sfvb_storefronts**](docs/SfvbApi.md#list_sfvb_storefronts) | **GET** /sfvb/storefronts | List storefronts
*UltracartClient::SfvbApi* | [**list_sfvb_templates**](docs/SfvbApi.md#list_sfvb_templates) | **GET** /sfvb/storefronts/{storefront_oid}/templates | List the active theme's templates
*UltracartClient::SfvbApi* | [**list_sfvb_themes**](docs/SfvbApi.md#list_sfvb_themes) | **GET** /sfvb/storefronts/{storefront_oid}/themes | List themes for a storefront
...
*UltracartClient::SfvbApi* | [**list_sfvb_upsell_paths**](docs/SfvbApi.md#list_sfvb_upsell_paths) | **GET** /sfvb/storefronts/{storefront_oid}/upsell_paths | List upsell paths
*UltracartClient::SfvbApi* | [**move_sfvb_upsell_path**](docs/SfvbApi.md#move_sfvb_upsell_path) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_paths/{upsell_path_oid}/move | Move an upsell path
...
*UltracartClient::SfvbApi* | [**put_sfvb_experiment_variation**](docs/SfvbApi.md#put_sfvb_experiment_variation) | **PUT** /sfvb/storefronts/{storefront_oid}/experiments/{experiment_oid}/variations/{variation_number} | Pause or resume a variation
...
*UltracartClient::SfvbApi* | [**put_sfvb_item_attributes**](docs/SfvbApi.md#put_sfvb_item_attributes) | **PUT** /sfvb/storefronts/{storefront_oid}/items/attributes | Change some of an item's attributes
*UltracartClient::SfvbApi* | [**put_sfvb_item_content**](docs/SfvbApi.md#put_sfvb_item_content) | **PUT** /sfvb/storefronts/{storefront_oid}/items/content | Change an item's title or long description
*UltracartClient::SfvbApi* | [**put_sfvb_item_multimedia**](docs/SfvbApi.md#put_sfvb_item_multimedia) | **PUT** /sfvb/storefronts/{storefront_oid}/items/multimedia | Attach an image to an item
*UltracartClient::SfvbApi* | [**put_sfvb_item_seo**](docs/SfvbApi.md#put_sfvb_item_seo) | **PUT** /sfvb/storefronts/{storefront_oid}/items/seo | Change an item's search metadata
*UltracartClient::SfvbApi* | [**put_sfvb_menu**](docs/SfvbApi.md#put_sfvb_menu) | **PUT** /sfvb/storefronts/{storefront_oid}/menus/{code} | Replace a store menu's entries
...
*UltracartClient::SfvbApi* | [**put_sfvb_page_selectors**](docs/SfvbApi.md#put_sfvb_page_selectors) | **PUT** /sfvb/storefronts/{storefront_oid}/pages/selectors | Replace a page's selectors
*UltracartClient::SfvbApi* | [**put_sfvb_page_settings**](docs/SfvbApi.md#put_sfvb_page_settings) | **PUT** /sfvb/storefronts/{storefront_oid}/pages/settings | Change a page's settings
...
*UltracartClient::SfvbApi* | [**put_sfvb_site_attributes**](docs/SfvbApi.md#put_sfvb_site_attributes) | **PUT** /sfvb/storefronts/{storefront_oid}/attributes | Change a storefront's site attributes
...
*UltracartClient::SfvbApi* | [**remove_sfvb_page_blog_posts**](docs/SfvbApi.md#remove_sfvb_page_blog_posts) | **POST** /sfvb/storefronts/{storefront_oid}/pages/blog_posts/remove | Take blog posts off a page
*UltracartClient::SfvbApi* | [**remove_sfvb_page_items**](docs/SfvbApi.md#remove_sfvb_page_items) | **POST** /sfvb/storefronts/{storefront_oid}/pages/items/remove | Take items off a page
...
*UltracartClient::SfvbApi* | [**resolve_sfvb_template**](docs/SfvbApi.md#resolve_sfvb_template) | **GET** /sfvb/storefronts/{storefront_oid}/templates/resolve | Resolve a template name to the file a page renders
...
*UltracartClient::SfvbApi* | [**start_sfvb_experiment**](docs/SfvbApi.md#start_sfvb_experiment) | **POST** /sfvb/storefronts/{storefront_oid}/experiments | Start an experiment
*UltracartClient::SfvbApi* | [**unarchive_sfvb_upsell_path**](docs/SfvbApi.md#unarchive_sfvb_upsell_path) | **POST** /sfvb/storefronts/{storefront_oid}/upsell_paths/{upsell_path_oid}/unarchive | Unarchive an upsell path
*UltracartClient::SfvbApi* | [**update_sfvb_upsell_offer**](docs/SfvbApi.md#update_sfvb_upsell_offer) | **PUT** /sfvb/storefronts/{storefront_oid}/upsell_offers/{upsell_offer_oid} | Update an upsell offer
*UltracartClient::SfvbApi* | [**update_sfvb_upsell_path**](docs/SfvbApi.md#update_sfvb_upsell_path) | **PUT** /sfvb/storefronts/{storefront_oid}/upsell_paths/{upsell_path_oid} | Update an upsell path
...
*UltracartClient::StorefrontApi* | [**get_email_review_status**](docs/StorefrontApi.md#get_email_review_status) | **GET** /storefront/{storefront_oid}/email/emails/{commseq_email_uuid}/review_status | Get the review status of an email
*UltracartClient::StorefrontApi* | [**get_email_review_statuses_multiple**](docs/StorefrontApi.md#get_email_review_statuses_multiple) | **POST** /storefront/{storefront_oid}/email/emails/review_status/multiple | Get the review status of multiple emails
...
## Documentation for Models
 ...
 - [UltracartClient::ConversationPbxPayConnector](docs/ConversationPbxPayConnector.md)
 - [UltracartClient::ConversationPbxPayConnectorsResponse](docs/ConversationPbxPayConnectorsResponse.md)
 ...
 - [UltracartClient::EmailCommseqEmailReviewStatus](docs/EmailCommseqEmailReviewStatus.md)
 - [UltracartClient::EmailCommseqEmailReviewStatusResponse](docs/EmailCommseqEmailReviewStatusResponse.md)
 - [UltracartClient::EmailCommseqEmailReviewStatusesRequest](docs/EmailCommseqEmailReviewStatusesRequest.md)
 - [UltracartClient::EmailCommseqEmailReviewStatusesResponse](docs/EmailCommseqEmailReviewStatusesResponse.md)
 ...
 - [UltracartClient::SfvbBlogPost](docs/SfvbBlogPost.md)
 - [UltracartClient::SfvbBlogPostsResponse](docs/SfvbBlogPostsResponse.md)
 - [UltracartClient::SfvbCompileRequest](docs/SfvbCompileRequest.md)
 - [UltracartClient::SfvbCompileResponse](docs/SfvbCompileResponse.md)
 - [UltracartClient::SfvbContainerResponse](docs/SfvbContainerResponse.md)
 - [UltracartClient::SfvbContainerRevertRequest](docs/SfvbContainerRevertRequest.md)
 - [UltracartClient::SfvbContainerVersion](docs/SfvbContainerVersion.md)
 - [UltracartClient::SfvbContainerVersionsResponse](docs/SfvbContainerVersionsResponse.md)
 - [UltracartClient::SfvbContainerWriteRequest](docs/SfvbContainerWriteRequest.md)
 - [UltracartClient::SfvbElement](docs/SfvbElement.md)
 - [UltracartClient::SfvbElementSchemaResponse](docs/SfvbElementSchemaResponse.md)
 - [UltracartClient::SfvbElementsResponse](docs/SfvbElementsResponse.md)
 - [UltracartClient::SfvbErrorDetail](docs/SfvbErrorDetail.md)
 - [UltracartClient::SfvbExperiment](docs/SfvbExperiment.md)
 - [UltracartClient::SfvbExperimentEndRequest](docs/SfvbExperimentEndRequest.md)
 - [UltracartClient::SfvbExperimentObjective](docs/SfvbExperimentObjective.md)
 - [UltracartClient::SfvbExperimentObjectivesResponse](docs/SfvbExperimentObjectivesResponse.md)
 - [UltracartClient::SfvbExperimentStartRequest](docs/SfvbExperimentStartRequest.md)
 - [UltracartClient::SfvbExperimentStartVariation](docs/SfvbExperimentStartVariation.md)
 - [UltracartClient::SfvbExperimentVariationUpdateRequest](docs/SfvbExperimentVariationUpdateRequest.md)
 - [UltracartClient::SfvbExperimentsResponse](docs/SfvbExperimentsResponse.md)
 - [UltracartClient::SfvbFileContentResponse](docs/SfvbFileContentResponse.md)
 - [UltracartClient::SfvbFileEntry](docs/SfvbFileEntry.md)
 ...
 - [UltracartClient::SfvbFileWriteResponse](docs/SfvbFileWriteResponse.md)
 - [UltracartClient::SfvbFilesResponse](docs/SfvbFilesResponse.md)
 - [UltracartClient::SfvbItemAttribute](docs/SfvbItemAttribute.md)
 - [UltracartClient::SfvbItemAttributeUpdate](docs/SfvbItemAttributeUpdate.md)
 - [UltracartClient::SfvbItemAttributeUpdateRequest](docs/SfvbItemAttributeUpdateRequest.md)
 - [UltracartClient::SfvbItemContainer](docs/SfvbItemContainer.md)
 - [UltracartClient::SfvbItemContainersResponse](docs/SfvbItemContainersResponse.md)
 - [UltracartClient::SfvbItemContentRequest](docs/SfvbItemContentRequest.md)
 - [UltracartClient::SfvbItemMultimedia](docs/SfvbItemMultimedia.md)
 - [UltracartClient::SfvbItemMultimediaRequest](docs/SfvbItemMultimediaRequest.md)
 - [UltracartClient::SfvbItemResponse](docs/SfvbItemResponse.md)
 - [UltracartClient::SfvbItemSeo](docs/SfvbItemSeo.md)
 - [UltracartClient::SfvbItemSeoRequest](docs/SfvbItemSeoRequest.md)
 ...
 - [UltracartClient::SfvbMenu](docs/SfvbMenu.md)
 - [UltracartClient::SfvbMenuItem](docs/SfvbMenuItem.md)
 - [UltracartClient::SfvbMenuWriteRequest](docs/SfvbMenuWriteRequest.md)
 - [UltracartClient::SfvbMenusResponse](docs/SfvbMenusResponse.md)
 ...
 - [UltracartClient::SfvbPageBlogPostSelector](docs/SfvbPageBlogPostSelector.md)
 - [UltracartClient::SfvbPageBlogPostsRequest](docs/SfvbPageBlogPostsRequest.md)
 - [UltracartClient::SfvbPageBlogPostsResponse](docs/SfvbPageBlogPostsResponse.md)
 - [UltracartClient::SfvbPageCreateRequest](docs/SfvbPageCreateRequest.md)
 - [UltracartClient::SfvbPageDuplicateRequest](docs/SfvbPageDuplicateRequest.md)
 - [UltracartClient::SfvbPageItem](docs/SfvbPageItem.md)
 - [UltracartClient::SfvbPageItemSelector](docs/SfvbPageItemSelector.md)
 - [UltracartClient::SfvbPageItemsAddRequest](docs/SfvbPageItemsAddRequest.md)
 - [UltracartClient::SfvbPageItemsRemoveRequest](docs/SfvbPageItemsRemoveRequest.md)
 - [UltracartClient::SfvbPageItemsResponse](docs/SfvbPageItemsResponse.md)
 - [UltracartClient::SfvbPageListResponse](docs/SfvbPageListResponse.md)
 ...
 - [UltracartClient::SfvbPageSelectors](docs/SfvbPageSelectors.md)
 - [UltracartClient::SfvbPageSettingsRequest](docs/SfvbPageSettingsRequest.md)
 - [UltracartClient::SfvbPageSummary](docs/SfvbPageSummary.md)
 - [UltracartClient::SfvbPreviewAccessRequest](docs/SfvbPreviewAccessRequest.md)
 - [UltracartClient::SfvbPreviewAccessResponse](docs/SfvbPreviewAccessResponse.md)
 ...
 - [UltracartClient::SfvbRenderRequest](docs/SfvbRenderRequest.md)
 - [UltracartClient::SfvbRenderResponse](docs/SfvbRenderResponse.md)
 - [UltracartClient::SfvbSiteAttribute](docs/SfvbSiteAttribute.md)
 - [UltracartClient::SfvbSiteAttributeUpdate](docs/SfvbSiteAttributeUpdate.md)
 - [UltracartClient::SfvbSiteAttributeUpdateRequest](docs/SfvbSiteAttributeUpdateRequest.md)
 - [UltracartClient::SfvbSiteAttributesResponse](docs/SfvbSiteAttributesResponse.md)
 ...
 - [UltracartClient::SfvbTemplate](docs/SfvbTemplate.md)
 - [UltracartClient::SfvbTemplateResolveCandidate](docs/SfvbTemplateResolveCandidate.md)
 - [UltracartClient::SfvbTemplateResolvePath](docs/SfvbTemplateResolvePath.md)
 - [UltracartClient::SfvbTemplateResolveResponse](docs/SfvbTemplateResolveResponse.md)
 - [UltracartClient::SfvbTemplatesResponse](docs/SfvbTemplatesResponse.md)
 ...
 - [UltracartClient::SfvbUpsellItemLogic](docs/SfvbUpsellItemLogic.md)
 - [UltracartClient::SfvbUpsellItemLogicItem](docs/SfvbUpsellItemLogicItem.md)
 - [UltracartClient::SfvbUpsellOffer](docs/SfvbUpsellOffer.md)
 - [UltracartClient::SfvbUpsellOffersResponse](docs/SfvbUpsellOffersResponse.md)
 - [UltracartClient::SfvbUpsellPath](docs/SfvbUpsellPath.md)
 - [UltracartClient::SfvbUpsellPathDuplicateRequest](docs/SfvbUpsellPathDuplicateRequest.md)
 - [UltracartClient::SfvbUpsellPathMoveRequest](docs/SfvbUpsellPathMoveRequest.md)
 - [UltracartClient::SfvbUpsellPathsResponse](docs/SfvbUpsellPathsResponse.md)
 - [UltracartClient::SfvbUpsellStats](docs/SfvbUpsellStats.md)
 - [UltracartClient::SfvbUpsellStep](docs/SfvbUpsellStep.md)
 - [UltracartClient::SfvbUpsellStepOffer](docs/SfvbUpsellStepOffer.md)
 - [UltracartClient::SfvbUpsellTowerData](docs/SfvbUpsellTowerData.md)
 - [UltracartClient::SfvbUpsellVariation](docs/SfvbUpsellVariation.md)
 - [UltracartClient::SfvbValidateRequest](docs/SfvbValidateRequest.md)
 - [UltracartClient::SfvbValidationResponse](docs/SfvbValidationResponse.md)
 - [UltracartClient::SfvbVelocityValidateRequest](docs/SfvbVelocityValidateRequest.md)
 - [UltracartClient::SfvbVersionResponse](docs/SfvbVersionResponse.md)
 - [UltracartClient::SfvbWhoamiResponse](docs/SfvbWhoamiResponse.md)
 - [UltracartClient::SfvbWidgetIdsResponse](docs/SfvbWidgetIdsResponse.md)
