  ...
  class OrderTrackingNumberDetail
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::OrderTrackingNumberDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::OrderTrackingNumberDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'event_local_date')
        self.event_local_date = attributes[:'event_local_date']
      end

      if attributes.key?(:'event_local_time')
        self.event_local_time = attributes[:'event_local_time']
      end

      if attributes.key?(:'event_timezone_id')
      ...
      if attributes.key?(:'tag_description')
        self.tag_description = attributes[:'tag_description']
      end

      if attributes.key?(:'tag_icon')
