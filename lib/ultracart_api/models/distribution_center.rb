  ...
  class DistributionCenter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::DistributionCenter` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::DistributionCenter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_center')
        self.default_center = attributes[:'default_center']
      end

      if attributes.key?(:'default_handles_all_items')
      ...
      if attributes.key?(:'estimate_from_distribution_center_oid')
      ...
      if attributes.key?(:'hold_before_shipment_minutes')
        self.hold_before_shipment_minutes = attributes[:'hold_before_shipment_minutes']
      end

      if attributes.key?(:'hold_before_transmission')
        self.hold_before_transmission = attributes[:'hold_before_transmission']
      end

      if attributes.key?(:'hold_auto_order_before_shipment_minutes')
        self.hold_auto_order_before_shipment_minutes = attributes[:'hold_auto_order_before_shipment_minutes']
      end
      ...
      if attributes.key?(:'no_customer_direct_shipments')
        self.no_customer_direct_shipments = attributes[:'no_customer_direct_shipments']
      end

      if attributes.key?(:'no_split_shipment')
      ...
      if attributes.key?(:'transmit_blank_costs')
