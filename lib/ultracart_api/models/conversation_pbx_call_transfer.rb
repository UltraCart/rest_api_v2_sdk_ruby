...
module UltracartClient
  class ConversationPbxCallTransfer
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transfer_reason')
      ...
      if attributes.has_key?(:'transferred_at_dts')
        self.transferred_at_dts = attributes[:'transferred_at_dts']
      end

      if attributes.has_key?(:'transferred_by_agent_id')
        self.transferred_by_agent_id = attributes[:'transferred_by_agent_id']
      end

      if attributes.has_key?(:'transferred_to')
