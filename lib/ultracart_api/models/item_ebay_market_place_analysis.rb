...
module ultracart_client
  class ItemEbayMarketPlaceAnalysis
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'adjusted_shipping')
        self.adjusted_shipping = attributes[:'adjusted_shipping']
      end

      if attributes.has_key?(:'adjusted_total')
      ...
      if attributes.has_key?(:'final_value_fee')
