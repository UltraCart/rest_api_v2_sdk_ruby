...
module UltracartClient
  class AffiliateClickQuery
    ...
    attr_accessor :click_dts_begin

    # Maximum click date/time to return
    attr_accessor :click_dts_end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::AffiliateClickQuery` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::AffiliateClickQuery`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'click_dts_begin')
        self.click_dts_begin = attributes[:'click_dts_begin']
      end

      if attributes.key?(:'click_dts_end')
        self.click_dts_end = attributes[:'click_dts_end']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          click_dts_begin == o.click_dts_begin &&
          click_dts_end == o.click_dts_end &&
    ...
    def hash
      [affiliate_link_oid, affiliate_oid, click_dts_begin, click_dts_end, ip_address, sub_id].hash
    end
