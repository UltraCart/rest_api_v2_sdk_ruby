...
module UltracartClient
  class CouponFreeItemsWithMixMatchPurchase
    ...
    attr_accessor :required_purchase_mix_and_match_group
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::CouponFreeItemsWithMixMatchPurchase` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::CouponFreeItemsWithMixMatchPurchase`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'free_item')
        self.free_item = attributes[:'free_item']
      end

      if attributes.key?(:'free_quantity')
      ...
      if attributes.key?(:'required_purchase_mix_and_match_group')
        self.required_purchase_mix_and_match_group = attributes[:'required_purchase_mix_and_match_group']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          free_item == o.free_item &&
          free_quantity == o.free_quantity &&
          limit == o.limit &&
          required_purchase_mix_and_match_group == o.required_purchase_mix_and_match_group &&
    ...
    def hash
      [free_item, free_quantity, limit, required_purchase_mix_and_match_group, required_purchase_quantity].hash
    end
