...
module UltracartClient
  class SfvbValidateRequest
    ...
    attr_accessor :include_warnings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::SfvbValidateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::SfvbValidateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'include_warnings')
        self.include_warnings = attributes[:'include_warnings']
      end

      if attributes.key?(:'marketing_email')
        self.marketing_email = attributes[:'marketing_email']
      end
    ...
    def valid?
      owner_type_validator = EnumAttributeValidator.new('String', ["theme", "page", "item", "upsell", "email", "postcard"])
    ...
    def owner_type=(owner_type)
      validator = EnumAttributeValidator.new('String', ["theme", "page", "item", "upsell", "email", "postcard"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          include_warnings == o.include_warnings &&
          marketing_email == o.marketing_email &&
    ...
    def hash
      [cjson, container_name, include_warnings, marketing_email, owner_type].hash
    end
