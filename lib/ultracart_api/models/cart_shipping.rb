  ...
  class CartShipping
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::CartShipping` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::CartShipping`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipping_3rd_party_account_number')
    ...
    def list_invalid_properties
      ...
      if !@postal_code.nil? && @postal_code.to_s.length > 25
        invalid_properties.push('invalid value for "postal_code", the character length must be smaller than or equal to 25.')
      end
      ...
      if !@shipping_method.nil? && @shipping_method.to_s.length > 40
        invalid_properties.push('invalid value for "shipping_method", the character length must be smaller than or equal to 40.')
      end
    ...
    def valid?
      ...
      return false if !@postal_code.nil? && @postal_code.to_s.length > 25
      return false if !@shipping_3rd_party_account_number.nil? && @shipping_3rd_party_account_number.to_s.length > 20
      return false if !@shipping_method.nil? && @shipping_method.to_s.length > 40
    ...
    def postal_code=(postal_code)
      if !postal_code.nil? && postal_code.to_s.length > 25
        fail ArgumentError, 'invalid value for "postal_code", the character length must be smaller than or equal to 25.'
      end
    ...
    def shipping_method=(shipping_method)
      if !shipping_method.nil? && shipping_method.to_s.length > 40
        fail ArgumentError, 'invalid value for "shipping_method", the character length must be smaller than or equal to 40.'
      end
    ...
    def hash
      [address1, address2, city, company, country_code, day_phone, delivery_date, evening_phone, first_name, last_name, lift_gate, postal_code, ship_on_date, ship_to_residential, shipping_3rd_party_account_number, shipping_method, special_instructions, state_region, title].hash
    end
