  ...
  class ItemRestriction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::ItemRestriction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::ItemRestriction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'one_per_customer')
        self.one_per_customer = attributes[:'one_per_customer']
      end

      if attributes.key?(:'purchase_separately')
        self.purchase_separately = attributes[:'purchase_separately']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          one_per_customer == o.one_per_customer &&
          purchase_separately == o.purchase_separately
    end
