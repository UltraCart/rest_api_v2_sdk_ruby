...
module UltracartClient
  class LibraryItemPurchasedMeta
    ...
    attr_accessor :most_recent_version
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::LibraryItemPurchasedMeta` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::LibraryItemPurchasedMeta`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'most_recent_version')
        self.most_recent_version = attributes[:'most_recent_version']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          most_recent_version == o.most_recent_version &&
    ...
    def hash
      [most_recent_version, my_purchased_version, upgrade_available].hash
    end
