  ...
  class ItemInstantPaymentNotification
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::ItemInstantPaymentNotification` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::ItemInstantPaymentNotification`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'post_operation')
        self.post_operation = attributes[:'post_operation']
      end

      if attributes.key?(:'successful_response_text')
        self.successful_response_text = attributes[:'successful_response_text']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          post_operation == o.post_operation &&
          successful_response_text == o.successful_response_text &&
          url == o.url
    end
    ...
    def hash
      [post_operation, successful_response_text, url].hash
    end
