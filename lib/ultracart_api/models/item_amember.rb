...
module UltracartClient
  class ItemAmember
    ...
    def self.openapi_types
      {
        :'amember_payment_duration_days' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::ItemAmember` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::ItemAmember`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'amember_payment_duration_days')
        self.amember_payment_duration_days = attributes[:'amember_payment_duration_days']
      end

      if attributes.key?(:'amember_product_id')
        self.amember_product_id = attributes[:'amember_product_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amember_payment_duration_days == o.amember_payment_duration_days &&
          amember_product_id == o.amember_product_id
    end
    ...
    def hash
      [amember_payment_duration_days, amember_product_id].hash
    end
