...
module UltracartClient
  class SfvbWhoamiResponse
    ...
    attr_accessor :storefronts_withheld
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::SfvbWhoamiResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::SfvbWhoamiResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'acting_as_user')
        self.acting_as_user = attributes[:'acting_as_user']
      end
      ...
      if attributes.key?(:'storefronts_withheld')
        self.storefronts_withheld = attributes[:'storefronts_withheld']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          storefronts_withheld == o.storefronts_withheld &&
