...
module ultracart_client
  class CustomerSoftwareEntitlement
    ...
    attr_accessor :activation_dts

    # Customer profile software entitlement object identifier
    attr_accessor :customer_software_entitlement_oid
    ...
    attr_accessor :purchased_via_item_description

    # Item ID used to purchase this software.
    attr_accessor :purchased_via_item_id

    # Order ID used to purchase this software.
    attr_accessor :purchased_via_order_id

    # SKU of the software
    attr_accessor :software_sku
    ...
    # Custom attribute writer method with validation
    # @param [Object] purchased_via_item_description Value to be assigned
    ...
    # Custom attribute writer method with validation
    # @param [Object] purchased_via_item_id Value to be assigned
    ...
    # Custom attribute writer method with validation
    # @param [Object] purchased_via_order_id Value to be assigned
    ...
    # Custom attribute writer method with validation
    # @param [Object] software_sku Value to be assigned
