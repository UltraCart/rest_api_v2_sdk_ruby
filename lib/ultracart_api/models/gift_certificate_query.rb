  ...
  class GiftCertificateQuery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::GiftCertificateQuery` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::GiftCertificateQuery`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expiration_dts_start')
        self.expiration_dts_start = attributes[:'expiration_dts_start']
      end

      if attributes.key?(:'original_balance_end')
        self.original_balance_end = attributes[:'original_balance_end']
      end

      if attributes.key?(:'original_balance_start')
      ...
      if attributes.key?(:'remaining_balance_end')
        self.remaining_balance_end = attributes[:'remaining_balance_end']
      end

      if attributes.key?(:'remaining_balance_start')
