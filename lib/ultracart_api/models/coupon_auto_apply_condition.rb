  ...
  class CouponAutoApplyCondition
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UltracartClient::CouponAutoApplyCondition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UltracartClient::CouponAutoApplyCondition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'required_item_id')
        self.required_item_id = attributes[:'required_item_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          required_item_id == o.required_item_id
    end
    ...
    def hash
      [coupon_code, minimum_subtotal, required_item_id].hash
    end
