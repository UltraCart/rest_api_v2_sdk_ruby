...
module UltracartClient
  class GiftCertificateApi
    ...
    # @param gift_certificate_oid [Integer] 
    # @param gift_certificate_ledger_entry [GiftCertificateLedgerEntry] Gift certificate ledger entry
    ...
    # @param gift_certificate_ledger_entry [GiftCertificateLedgerEntry] Gift certificate ledger entry
    # @param [Hash] opts the optional parameters
    # @return [Array<(GiftCertificateResponse, Integer, Hash)>] GiftCertificateResponse data, response status code and response headers
    def add_gift_certificate_ledger_entry_with_http_info(gift_certificate_oid, gift_certificate_ledger_entry, opts = {})
      ...
      # resource path
      local_var_path = '/gift_certificate/gift_certificates/{gift_certificate_oid}/ledger_entry'.sub('{' + 'gift_certificate_oid' + '}', CGI.escape(gift_certificate_oid.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(gift_certificate_ledger_entry)

      # return_type
      return_type = opts[:debug_return_type] || 'GiftCertificateResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ultraCartOauth', 'ultraCartSimpleApiKey']

      new_options = opts.merge(
        :operation => :"GiftCertificateApi.add_gift_certificate_ledger_entry",
    ...
    # @param gift_certificate_create_request [GiftCertificateCreateRequest] Gift certificate create request
    # @param [Hash] opts the optional parameters
    # @return [GiftCertificateResponse]
    ...
    def create_gift_certificate_with_http_info(gift_certificate_create_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(gift_certificate_create_request)
      ...
      new_options = opts.merge(
        :operation => :"GiftCertificateApi.create_gift_certificate",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_gift_certificate_with_http_info(gift_certificate_oid, opts = {})
      ...
      # resource path
      local_var_path = '/gift_certificate/gift_certificates/{gift_certificate_oid}'.sub('{' + 'gift_certificate_oid' + '}', CGI.escape(gift_certificate_oid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"GiftCertificateApi.delete_gift_certificate",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_gift_certificate_by_code_with_http_info(code, opts = {})
      ...
      # resource path
      local_var_path = '/gift_certificate/gift_certificates/by_code/{code}'.sub('{' + 'code' + '}', CGI.escape(code.to_s))
      ...
      new_options = opts.merge(
        :operation => :"GiftCertificateApi.get_gift_certificate_by_code",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_gift_certificate_by_oid_with_http_info(gift_certificate_oid, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GiftCertificateApi.get_gift_certificate_by_oid",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param email [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GiftCertificatesResponse, Integer, Hash)>] GiftCertificatesResponse data, response status code and response headers
    def get_gift_certificates_by_email_with_http_info(email, opts = {})
      ...
      # resource path
      local_var_path = '/gift_certificate/gift_certificates/by_email/{email}'.sub('{' + 'email' + '}', CGI.escape(email.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GiftCertificatesResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ultraCartOauth', 'ultraCartSimpleApiKey']

      new_options = opts.merge(
        :operation => :"GiftCertificateApi.get_gift_certificates_by_email",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param gift_certificate_query [GiftCertificateQuery] Gift certificates query
    # @param [Hash] opts the optional parameters
    ...
    def get_gift_certificates_by_query_with_http_info(gift_certificate_query, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(gift_certificate_query)
      ...
      new_options = opts.merge(
        :operation => :"GiftCertificateApi.get_gift_certificates_by_query",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param gift_certificate_oid [Integer] 
    # @param gift_certificate [GiftCertificate] Gift certificate
    # @param [Hash] opts the optional parameters
    # @return [GiftCertificateResponse]
    ...
    def update_gift_certificate_with_http_info(gift_certificate_oid, gift_certificate, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(gift_certificate)
      ...
      new_options = opts.merge(
        :operation => :"GiftCertificateApi.update_gift_certificate",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
