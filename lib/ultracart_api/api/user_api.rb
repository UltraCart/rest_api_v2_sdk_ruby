...
module UltracartClient
  class UserApi
    ...
    # @param group_oid [Integer] The group_oid to delete.
    ...
    def delete_group_with_http_info(group_oid, opts = {})
      ...
      # resource path
      local_var_path = '/user/groups/{group_oid}'.sub('{' + 'group_oid' + '}', CGI.escape(group_oid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserApi.delete_group",
    ...
    # @param user_id [Integer] The user_id to delete.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def delete_user_with_http_info(user_id, opts = {})
      ...
      # resource path
      local_var_path = '/user/users/{user_id}'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
    ...
    # @param group_oid [Integer] The group id to retrieve.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    # Get groups
    # @param [Hash] opts the optional parameters
    # @return [Array<(GroupsResponse, Integer, Hash)>] GroupsResponse data, response status code and response headers
    def get_groups_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GroupsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ultraCartOauth', 'ultraCartSimpleApiKey']

      new_options = opts.merge(
        :operation => :"UserApi.get_groups",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param user_id [Integer] The user id to retrieve.
    # @param [Hash] opts the optional parameters
    # @return [UserResponse]
    ...
    # @param user_id [Integer] The user id to retrieve.
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserLoginsResponse, Integer, Hash)>] UserLoginsResponse data, response status code and response headers
    def get_user_logins_with_http_info(user_id, opts = {})
      ...
      # resource path
      local_var_path = '/user/users/{user_id}/logins'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserLoginsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ultraCartOauth', 'ultraCartSimpleApiKey']

      new_options = opts.merge(
        :operation => :"UserApi.get_user_logins",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def insert_group_with_http_info(group, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UserApi.insert_group",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param group_oid [Integer] The group_oid to update.
    # @param group [Group] Group to update
    # @param [Hash] opts the optional parameters
    # @return [GroupResponse]
    def update_group(group_oid, group, opts = {})
      data, _status_code, _headers = update_group_with_http_info(group_oid, group, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GroupResponse, Integer, Hash)>] GroupResponse data, response status code and response headers
    def update_group_with_http_info(group_oid, group, opts = {})
      if @api_client.config.debugging
      ...
      new_options = opts.merge(
        :operation => :"UserApi.update_group",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param user_id [Integer] The user_id to update.
