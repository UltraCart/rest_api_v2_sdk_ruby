...
module UltraCartAdminV2
  class ItemApi
    ...
    def get_item_by_merchant_item_id_with_http_info(merchant_item_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'merchant_item_id' when calling ItemApi.get_item_by_merchant_item_id" if merchant_item_id.nil?
      # resource path
      local_var_path = "/item/items/merchant_item_id/{merchant_item_id}".sub('{format}','json').sub('{' + 'merchant_item_id' + '}', merchant_item_id.to_s)
    ...
    def get_pricing_tiers_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/item/pricing_tiers".sub('{format}','json')
    ...
    def update_items_with_http_info(items_request, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'items_request' when calling ItemApi.update_items" if items_request.nil?
      # resource path
      local_var_path = "/item/items/batch".sub('{format}','json')
