...
module UltraCartAdminV2
  ...
  class EmailCommseqEmail
    ...
    def hash
      [deleted, edited_by_user, email_communication_sequence_email_uuid, email_container_cjson, email_template_vm_path, filter_profile_equation_json, individually_render, merchant_id, preview_text, smart_sending, storefront_oid, subject, transactional_email, version].hash
    end
