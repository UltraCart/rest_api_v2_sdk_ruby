...
module UltraCartAdminV2
  class Metric
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'all_time')
        self.all_time = attributes[:'all_time']
      end

      if attributes.has_key?(:'all_time_formatted')
        self.all_time_formatted = attributes[:'all_time_formatted']
      end

      if attributes.has_key?(:'last_30')
        self.last_30 = attributes[:'last_30']
      end

      if attributes.has_key?(:'last_30_formatted')
      ...
      if attributes.has_key?(:'prior_30')
        self.prior_30 = attributes[:'prior_30']
      end

      if attributes.has_key?(:'prior_30_formatted')
