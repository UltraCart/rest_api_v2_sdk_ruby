...
module UltraCartAdminV2
  class CustomerLoyaltyRedemption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'coupon_code_oid')
        self.coupon_code_oid = attributes[:'coupon_code_oid']
      end

      if attributes.has_key?(:'coupon_used')
        self.coupon_used = attributes[:'coupon_used']
      end

      if attributes.has_key?(:'description_for_customer')
      ...
      if attributes.has_key?(:'loyalty_redemption_oid')
      ...
      if attributes.has_key?(:'redemption_dts')
