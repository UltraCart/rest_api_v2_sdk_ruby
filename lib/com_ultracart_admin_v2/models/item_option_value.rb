...
module UltraCartAdminV2
  ...
  class ItemOptionValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'additional_items')
      ...
      if attributes.has_key?(:'option_value_oid')
        self.option_value_oid = attributes[:'option_value_oid']
      end

      if attributes.has_key?(:'percent_cost_change')
      ...
      if attributes.has_key?(:'weight_change_percent')
