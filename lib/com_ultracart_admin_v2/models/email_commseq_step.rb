...
module UltraCartAdminV2
  ...
  class EmailCommseqStep
    ...
    def hash
      [alt_child_email_communication_sequence_steps, child_email_communication_sequence_steps, email_communication_sequence_step_uuid, filter_profile_equation_json, step_config_json, type].hash
    end
