# UltracartClient::SfvbTemplateResolvePath

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **candidates** | [**Array&lt;SfvbTemplateResolveCandidate&gt;**](SfvbTemplateResolveCandidate.md) | Every file of that name below this path, in the order the storefront searches. | [optional] |
...
instance = UltracartClient::SfvbTemplateResolvePath.new(
  candidates: null,
