# UltracartClient::SfvbTemplateResolveResponse
...
| **resource_paths** | [**Array&lt;SfvbTemplateResolvePath&gt;**](SfvbTemplateResolvePath.md) | The theme&#39;s resource paths in search order, each with the files of that name found below it.  The first path with a match wins, which is how a theme copy overrides a shared core copy. | [optional] |
| **theme_oid** | **Integer** | The theme the name was resolved in. | [optional] |
...
instance = UltracartClient::SfvbTemplateResolveResponse.new(
  exists: null,
  fallback: null,
  name: null,
  resolved_path: null,
