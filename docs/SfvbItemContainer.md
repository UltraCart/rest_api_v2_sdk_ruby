# UltracartClient::SfvbItemContainer

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **cjson_size** | **Integer** | Size of the CJSON in UTF-8 bytes, which is the same unit the container version size and the upsell offer cjson_size use. | [optional] |
...
| **used_elements** | **Array&lt;String&gt;** | The element types this container uses, recorded by the storage when it was written.  A large cjson_size beside a handful of element types is the signature of markup pasted into a single html element.  Absent on a container written before the storage began recording this. | [optional] |
...
instance = UltracartClient::SfvbItemContainer.new(
  cjson_size: null,
  container_name: null,
  hash_sha256: null,
  last_modified: null,
