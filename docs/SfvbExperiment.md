# UltracartClient::SfvbExperiment
...
| **days_elapsed** | **Integer** | Whole days the experiment has run, up to now or to when it ended. | [optional] |
...
instance = UltracartClient::SfvbExperiment.new(
  auto_ends_at: null,
  days_elapsed: null,
  experiment: null,
  notice: null,
