...
api_instance = UltraCartAdminV2::UserApi.new
...
group = UltraCartAdminV2::Group.new # Group | Group to insert
...
user = UltraCartAdminV2::User.new # User | User to insert
...
group = UltraCartAdminV2::Group.new # Group | Group to update
...
user = UltraCartAdminV2::User.new # User | User to update
